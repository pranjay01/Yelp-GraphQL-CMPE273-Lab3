...
class CustomerLogin extends Component {
  ...
  onSubmitSignUp = (e) => {
    ...
    // axios.post(serverUrl + 'customer/signup', data)
    ...
    this.props.client
      ...
      .then(
        (response) => {
          ...
          if (response.data.customerSignup.Result === 'Customer Created') {
          ...
          } else if (response.data.customerSignup.Result === 'Email Already Exists') {
            let payload = {
              success: true,
