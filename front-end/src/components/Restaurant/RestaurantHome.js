...
class RestaurantHome extends Component {
  ...
  componentDidMount() {
    ...
    this.props.client
      ...
      .then(
        (response) => {
          console.log('restaurant response:', response.data.getRestaurantInfo);

          let payload = {
            restaurantAddress:
              response.data.getRestaurantInfo.Street +
              ' ' +
              response.data.getRestaurantInfo.City +
              ' ' +
              response.data.getRestaurantInfo.StateName +
              ' ' +
              response.data.getRestaurantInfo.Zip,
            ...response.data.getRestaurantInfo,
            reviewCount: response.data.getRestaurantInfo.ReviewCounts,
          };
